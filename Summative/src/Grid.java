...
public abstract class Grid {
	...
	public void saveLabelField() { //Convert the label fields arrays to label arrays
		colLabels = PuzzleSolver.colLabelsToStringArr(colLabelField);
		rowLabels = PuzzleSolver.rowLabelsToStringArr(rowLabelField);
	}
